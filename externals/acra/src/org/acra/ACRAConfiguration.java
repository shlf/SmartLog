...
public class ACRAConfiguration implements ReportsCrashes {
    ...
    /**
     * @param deleteUnapprovedReportsOnApplicationStart the
     *            deleteUnapprovedReportsOnApplicationStart to set
     */
    public ACRAConfiguration setDeleteUnapprovedReportsOnApplicationStart(
     ...
     */
    public ACRAConfiguration setDeleteOldUnsentReportsOnApplicationStart(
            Boolean deleteOldUnsetReportsOnApplicationStart) {
     ...
     * @throws ACRAConfigurationException if a configuration item is missing for
     *             this mode.
     */
    public ACRAConfiguration setMode(ReportingInteractionMode mode)
     ...
     * 
     * @param resId The resource id, see
     *            {@link ReportsCrashes#resDialogOkToast()}
     */
    ...
    /**
     * @param filterByPid true if you want to collect only logcat lines related
    ...
    /**
     * @param sendReportsInDevMode false if you want to disable sending reports
     *            in development mode. Reports will be sent only on signed
     *            applications.
     */
    ...
    /**
     * @param excludeMatchingSharedPreferencesKeys an array of Strings
     *            containing regexp defining SharedPreferences keys that should
     *            be excluded from the data collection.
     */
    public ACRAConfiguration setExcludeMatchingSharedPreferencesKeys(
    ...
    /**
     * @param excludeMatchingSettingsKeys an array of Strings containing regexp
     *            defining Settings.System, Settings.Secure and Settings.Global
     *            keys that should be excluded from the data collection.
     */
    ...
    /**
     * @param applicationLogFile The path and file name of your application log
     *            file, to be used with {@link ReportField#APPLICATION_LOG}.
     */
    ...
    /**
     * @param applicationLogFileLines The number of lines of your application
     *            log to be collected, to be used with
     *            {@link ReportField#APPLICATION_LOG} and
    ...
    /**
     * @param disableSSLCertValidation Set this to true if you need to send
     *            reports to a server over SSL using a self-signed certificate.
     */
    ...
    /**
     * @param keyStore Set this to the keystore that contains the trusted
     *            certificates
     */
    ...
    public String[] logcatArguments() {
        ...
        String[] defaultValues = {
                "-t", Integer.toString(DEFAULT_LOGCAT_LINES), "-v", "time"
        };
    ...
    // FIXME : add save path.
    public ACRAConfiguration setSavePath(String savePath) {
    ...
    public String savePath() {
        ...
        if (mReportsCrashes != null) {
            return mReportsCrashes.savePath();
        }
