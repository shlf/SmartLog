...
public class CrashReportDialog extends Activity implements DialogInterface.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialogBuilder.setPositiveButton(getText(ACRA.getConfig().resDialogPositiveButtonText()),
                CrashReportDialog.this);
        dialogBuilder.setNegativeButton(getText(ACRA.getConfig().resDialogNegativeButtonText()),
                CrashReportDialog.this);
        cancelNotification();
    ...
    private void sendCrash() {
        ...
        try {
            ...
            final CrashReportData crashData = persister.load(mReportFileName, ACRA.getConfig()
                    .savePath());
            crashData.put(USER_COMMENT, comment);
            crashData.put(USER_EMAIL, usrEmail);
            persister.store(crashData, mReportFileName, ACRA.getConfig().savePath());
        } catch (IOException e) {
